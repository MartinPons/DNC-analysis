...
En la figura 2 se muestran los hashtags 15 más empleados por cada comunidad, y los que tienden a aparecer conjuntamente con otros hashtags en el mismo tweet de entre los 30 más empleados. Se incluyen aquí solamente los hashtags relacionados entre ellos por un **coeficiente phi** mayor que 0,1. 

Los tres grupos manifiestan prioridad por de apoyo a los trabajadores sanitarios (*#fuelingthefrontline*, *#healthcareheroes*, *#nationalnursesweek*),  el DNC critica la gestión del COVID por parte del presidente de los EE.UU (*#trumpgenocide*, *#trumpownseverydeath*) y solamente el grupo progresista prioriza directamente medidas de apoyo a los trabajadores y personas desfavorecidas como consecuencia de la pandemia (*#peoplesbailaout, #recovery4all*).
...
Sorprendentemente "public option" no se menciona en los tweets sobre MFA.
...
Aunque las precauciones que hay que tener presentes, relacionadas con la intencionalidad real de un tweet, de un hashtag o con el nivel de actividad de los usuarios, hacen que uno tenga que ir con pies de plomo cuando se trata de tomar cualquier tipo de conclusión, unas pautas no del todo conclusivas, aunque en algunos casos bastante orientativas, parecen emerger de entre los tweets analizados.

Exceptuando la disponibilidad de equipo sanitario durante la pandemia del virus que provoca la enfermedad COVID19 (*#ppe*), las únicas preocupaciones que moderados y progresistas del partído demócrata tienen en común, tambíen aparecen entre los hashtags más empleados en el partído republicano: el apoyo a los trabajadores sanitarios. El apoyo directo a trabajadores y personas desfavorecidas consecuencia de la pandemia (*#peoplesbailout*, *#recoveryforall*) solo es mencionado por el grupo progresista.
...
Los programas sanitarios en funcionamiento en la actualidad no son priorizados por el movimiento progresista, mientras que en el ala moderada, están entre los tópicos más mencionados.
